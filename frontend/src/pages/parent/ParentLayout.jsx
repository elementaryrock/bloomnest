...
const ParentLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    {
      path: "/parent/neural-narrative",
      icon: Sparkles,
      label: "NeuralNarrative™",
    },
    { path: "/parent/skill-sprout", icon: Sprout, label: "SkillSprout" },
    { path: "/parent/therapy-ripple", icon: Waves, label: "Therapy Ripple" },
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden bg-[#F8FAFC]">
          ...
          <header className="hidden lg:flex items-center justify-between px-8 py-5 bg-white/80 backdrop-blur-md border-b border-slate-200/60 sticky top-0 z-20">
            ...
            >
              <Search
                size={16}
                className="text-slate-400 absolute left-3 group-focus-within:text-blue-500 transition-colors"
                strokeWidth={2.5}
              />
              <input
                type="text"
                  ...
                  {filteredSessions.length > 0 ? (
                    <div className="max-h-80 overflow-y-auto">
                      ...
                      {filteredSessions.map((session) => (
                        ...
                        >
                          <div
                            className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${session.type === "upcoming" ? "bg-blue-100 text-blue-600" : "bg-emerald-100 text-emerald-600"}`}
                          >
                    ...
                    <div className="p-8 text-center">
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        Try searching for therapy type or date
                      </p>
                    </div>
                  )}
                </div>
                      ...
                      {[
                        {
                          ...
                          desc: "Speech Therapy with Dr. Sarah in 2 hours",
                          time: "2h ago",
                          type: "alert",
                          unread: true,
                        },
                        {
                          ...
                          desc: "Monthly progress report is ready to view",
                          time: "1d ago",
                          type: "doc",
                          unread: true,
                        },
                        {
                          ...
                          desc: "Occupational Therapy on Thursday, 10 AM",
                          time: "2d ago",
                          type: "success",
                          unread: false,
                        },
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-hover border border-slate-100 z-50 overflow-hidden animate-fadeIn p-2">
                    ...
                    {[
                      ...
                      },
                      {
                        ...
                        path: "/parent/contact-support",
                      },
                      {
                        icon: ExternalLink,
                        label: "Bloomnest Community",
                        path: "#",
                      },
                    ].map((item, idx) => (
                      <button
