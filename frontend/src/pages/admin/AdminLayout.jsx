...
const AdminLayout = ({ children }) => {
    ...
    const navItems = [
        ...
        { path: '/admin/schedule', icon: Calendar, label: 'Schedule Config' },
                    ...
                    <div className="p-4 mt-auto">
                        <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex items-center gap-3 hover:border-slate-300 transition-premium cursor-pointer group mb-2">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="font-bold text-slate-900 text-sm truncate">{user?.name || 'Administrator'}</p>
                                <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider truncate">System Admin</p>
                            </div>
                                ...
                                {notificationsOpen && (
                                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-hover border border-slate-100 z-50 overflow-hidden animate-fadeIn">
                                        ...
                                        <div className="max-h-96 overflow-y-auto">
                                            {[
                                                { id: 1, title: 'Staff Update', desc: 'New therapist profile created', time: '10m ago', type: 'success', unread: true },
                                                { id: 2, title: 'System Alert', desc: 'Schedule backup completed', time: '2h ago', type: 'doc', unread: true },
                                                { id: 3, title: 'New Registration', desc: '2 new staff members added today', time: '5h ago', type: 'alert', unread: false }
                                            ].map(n => (
